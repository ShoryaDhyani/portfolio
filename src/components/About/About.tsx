    ...
    <Container id="about">
      <div className="about-text">
        ...
        <ScrollAnimation animateIn="fadeInLeft" delay={0.1 * 1000}>
          <p>
            Hi there! I'm Shorya, an enthusiastic Software Engineer skilled in
        ...
        <ScrollAnimation animateIn="fadeInLeft" delay={400}>
          <div className="education">
            <h3>Education:</h3>
            <h4> Bachelor in COmputer Science Engineering (B.Tech)</h4>
            <p>
              Graphic Era Hill University - Dehradun  (2022-26)
            </p>
            {/* <p>8.09 CGPA</p> */}
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation style={{marginTop: 150}} animateIn="fadeInLeft" delay={0.4 * 1000}>
      ...
      {/* <div className="about-image"> */}
        {/* <ScrollAnimation animateIn="fadeInRight" delay={0.21 * 1000}>
          <img src={hello} alt="Vinayak Singh" />
        </ScrollAnimation>
      </div> */}
    </Container>
  );
